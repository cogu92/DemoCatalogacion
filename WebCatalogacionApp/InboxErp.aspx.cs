...
{
    public partial class InboxErp : System.Web.UI.Page
    {
        ...
        public void loadGrid_all()
        {
            ...
            if (Session["pIdRol"].ToString() == "2")
                GridInfo.DataSource = dbconsultas.Consultar(coneccion, ref pError, "[Ct_view_Inbox]", "TOP(50) Numero_Solicitud as [No.Solicitud], [Solicitud],[Descripcion],CONVERT(VARCHAR(10),[Fecha_Solicitud], 103) as Fecha_Solicitud,[nombre],[apellido],[Description]  as Estaso", "Es_ERP=1 AND Id=5 order by 1 desc");
            else
                GridInfo.DataSource = dbconsultas.Consultar(coneccion, ref pError, "[Ct_view_Inbox]", "TOP(50) Numero_Solicitud as [No.Solicitud], [Solicitud],[Descripcion],CONVERT(VARCHAR(10),[Fecha_Solicitud], 103) as Fecha_Solicitud,[nombre],[apellido],[Description] as Estaso", "Es_ERP=1 AND Id_user=" + Session["pIdUser"] + " order by 1 desc");
